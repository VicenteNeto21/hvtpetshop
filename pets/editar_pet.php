...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt_tutor->execute([$nome_tutor, $email_tutor, $telefone_tutor, $pet['tutor_id']]);
...
<body class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-200 flex flex-col">
    ...
    <main class="flex-1 w-full max-w-2xl mx-auto mt-10 p-4">
        ...
        <form action="" method="POST" class="bg-white/90 p-8 rounded-2xl shadow-xl space-y-8 animate-fade-in">
            ...
            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg shadow-md transition duration-300">
                <i class="fas fa-save mr-2"></i> Salvar Alterações
            </button>
            <a href="visualizar_pet.php?id=<?= $petId ?>" class="w-full block text-center bg-gray-400 hover:bg-gray-500 text-white py-3 rounded-lg shadow-md transition duration-300 mt-2">
